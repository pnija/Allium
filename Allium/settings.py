"""
Django settings for Allium project.
...
SECRET_KEY = '@p^orf-()jw)^b-*#b9xid=g3z-bz$mue_3v$#02d=1s&%78d%'
...
WSGI_APPLICATION = 'Allium.wsgi.application'
